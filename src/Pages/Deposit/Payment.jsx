...
const Payment = () => {
    ...
    const [state, setState] = useState({
        value: `${paymentname === "BTC"? ("bc1qp5xaf54n35qkudt4d0ajjqc4duexe0klksse99"): paymentname === "ETH"? ("0xA21438f6bC71cf515D9D4572fBB843bf5624347B"):"Chosse a Payment Method"}`,
        copied: false,
      });

      const url = `https://experttradesnewbackend.onrender.com/api/sendpayment/${id}`
      const url2 = `https://experttradesnewbackend.onrender.com/api/deposit/${id}`
