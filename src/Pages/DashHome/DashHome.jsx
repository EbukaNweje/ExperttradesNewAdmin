...
const DashHome = ({
    ...
    const url3 = `https://experttradesnewbackend.onrender.com/api/getalltransactions/${id}`
    const url4 = `https://experttradesnewbackend.onrender.com/api/getalluserplan/${id}`
        ...
        <>
            <div className="DashHomeBody">
                ...
                <div className="DashHomeInfoBox1">
                    <p>Welcome to Experttrades, You set the level.</p>
                </div>
                ...
                <div className="DashHomeMainContent">
                    ...
                    <div className="DashHomeMainContenReferUsDiv">
                        ...
                        <div className="DashHomeMainContenReferUsDivBox">
                            <input
                                type="text"
                                value={`https://www.experttrades.org`}
                                readOnly
                            />
